...
import { PERSONA, VOICE_STYLE } from "./persona";
...
- Speak only the public spoken wording returned by the tool. Do not add substantive claims to it. If there is a clarification, ask it. If there is a gap or escalation, give only its public acknowledgement and next step. Never speak internal drafts, review notes or private operational fields. If a tool fails, acknowledge the failure briefly; never pretend it succeeded.
